                        ...
                        <div class="card border-0 shadow mb-4 p-3">
                            <div class="card-body card-form">
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h3 class="fs-4 mb-1">Applied Job</h3>
                                    </div>
                                    ...
                                    <table class="table ">
                                        ...
                                        <tbody class="border-0">
                                            @if ($jobApplications->isEmpty())
                                                <tr>
                                                    <td colspan="5" class="text-center"> No Applied Job are Here! </td>
                                                </tr>
                                            @else
                                                    ...
                                                    <tr class="active">
                                                        <td>
                                                            <div class="job-name fw-500">
                                                                {{ $jobApplication->job->job_name }}</div>
                                                            ...
                                                            <div class="action-dots float-end">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                    <li><a class="dropdown-item"
                                                                            href="{{ route('job.show', $jobApplication->job_id) }}"><i
                                                                    ...
                                                                    <li>
                                                                        <form
                                                                            action="{{ route('appliedjob.delete', $jobApplication) }}"
                                                                            method="post">
                                                                            @csrf
                                                                            @method('DELETE')
