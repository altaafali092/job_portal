        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    @endif
                    <form action="{{ route('admin.jobCategory.update',$jobCategory) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label>Name</label>
                                <input class="form-control" type="text" name="name" value="{{ old('name',$jobCategory->name) }}" />
                            </div>
                            <div class="form-group col-md-6">
                                <label>Slug</label>
                                <input class="form-control" name="slug" value="{{ old('slug',$jobCategory->slug) }}" type="text" />
                            </div>
                        </div>
                        <div>
